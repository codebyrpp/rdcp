...
import { FileFieldValidation, FileFieldValidationInstance } from './validations';
...
type CustomValidationInstance = FileFieldValidationInstance & {
    schema: typeof fileSchema;
}
...
function PropertiesComponent({ validationInstance, update }: {
    validationInstance: FileFieldValidationInstance,
    update: (validation: FileFieldValidationInstance) => void
}) {
...
export const FileUploadValidation: FileFieldValidation = {
    type: "file",
    name: "",
    schema: fileSchema,
